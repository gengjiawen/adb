...
enum ConnectionState {
    ...
    kCsRecovery,    // Device with bootloader loaded and awaiting instructions (adbd).
    kCsSideload,    // Device running Android OS in Sideload mode (minadbd) (OTA packages install).
    kCsRescue,      // Device running Android OS in Rescue mode (minadbd).
};

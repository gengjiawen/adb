...
struct PropertyMonitor {
    ...
    //
    // This performs one cycle of checking for property changes. Note that this will return as soon
    // as any properties in the system are changed, not just the ones being monitored.
    //

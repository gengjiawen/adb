...
struct fdevent_context {
  ...
  public:
    ...
    // Assert that the current invocation is *not* in the
    // context of the active loop thread.
    void CheckNotLooperThread() const;

    inline std::optional<uint64_t> looper_thread_id() const { return looper_thread_id_; }

...
Connects to the ADB Server via its smart socket interface. Allows sending requests, receives responses and manages lifecycle.
...
uninstall [**-k**] **APPLICATION ID**   
&nbsp;&nbsp;&nbsp;&nbsp;Remove this **APPLICATION ID** from the device.

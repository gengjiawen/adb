...
$ADB_MDNS_OPENSCREEN
&nbsp;&nbsp;&nbsp;&nbsp;The default mDNS-SD backend is Bonjour (mdnsResponder). For machines where Bonjour is not installed, adb can spawn its own mDNS-SD back,
openscreen. If set to "1", this env variable forces mDNS backend to openscreen.

...
&nbsp;&nbsp;&nbsp;&nbsp;(macOS only, running ADB_LIBUSB=0) Allow the ability to clear both endpoints (send ENDPOINT_HALT) in order to address [adb install problems](https://issuetracker.google.com/issues/270205252).

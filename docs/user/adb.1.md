...
&nbsp;&nbsp;&nbsp;&nbsp;(macOS only, running ADB_LIBUSB=0) Allow the ability to clear both endpoints (send ENDPOINT_HALT) in order to address [device recognition problems](https://issuetracker.google.com/issues/37055927).

...
**-e**
&nbsp;&nbsp;&nbsp;&nbsp;Specifies the escape character for a session; the default character is '~'. Setting this character to 'none' deactivates all escape sequences. An escape character is only recognized if it is at the beginning of the line.

...
$ADB_LIBUSB
&nbsp;&nbsp;&nbsp;&nbsp;ADB has a USB Debug Accessory implementation but can
also employ libusb. Use  `adb devices -l` or `adb host-features` to identify
which is in use. To override the default for your OS, you can set ADB_LIBUSB to
"1" to enable libusb, or "0" to enabhle the debug accessory implementation.

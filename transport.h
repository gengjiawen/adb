...
struct Connection {
    ...
    virtual ConnectionSpeed NegotiatedSpeedMbs() { return UNKNOWN; }
    virtual ConnectionSpeed MaxSpeedMbs() { return UNKNOWN; }
};
...
enum TrackerOutputType { TEXT, LONG_TEXT, PROTOBUFFER, TEXT_PROTOBUFFER };

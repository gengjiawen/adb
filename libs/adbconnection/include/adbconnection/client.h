...
// transferred to the server. You need to call adbconnection_client_send_update to transmit the
// latest state to adbd.
void adbconnection_client_set_waiting_for_debugger(bool waiting) __INTRODUCED_IN(__ANDROID_API_V__);
...
// You need to call adbconnection_client_send_update to transmit the latest state to adbd.
void adbconnection_client_set_user_id(int uid) __INTRODUCED_IN(__ANDROID_API_V__);
...
// should be called.
bool adbconnection_client_has_pending_update() __INTRODUCED_IN(__ANDROID_API_V__);

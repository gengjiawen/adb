...
const char* const kFeatureDisableVerityShell = "disable-verity_shell";
const char* const kFeatureEnableVerityShell = "enable-verity_shell";
...
const FeatureSet& supported_features() {
    static const android::base::NoDestructor<FeatureSet> features([] {
        return FeatureSet{
                ...
                kFeatureDisableVerityShell,
                kFeatureEnableVerityShell,
                kFeatureTrackApp,
                kFeatureSendRecv2,

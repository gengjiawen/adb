...
class SystemPropertiesTest(DeviceTest):
    ...
    # Tests property setting and retrieval, without the reliance
    # on root - root-signals(e.g system prop like
    # ro.debuggable) are undesirable because 3p apps tend to
    # utilize the userdebug-only interfaces inappropriately.
    # ro.debuggable is therefore revamped to a build-time
    # property.
